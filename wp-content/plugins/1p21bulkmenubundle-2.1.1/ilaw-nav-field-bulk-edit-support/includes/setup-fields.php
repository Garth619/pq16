...
--------------------------------------------------------------------------------------- */
	...
	function _ilaw_sm_load_other_cpts_choices_to_global_settings_repeater($field){
		...
		//clear out whatever custom bois was ther but shouldbnt even be there because this is a plugin and is used by other sites so one site might need a product post type but another might not so why why why you know you get the idea shit
		$field['choices'] = array();
